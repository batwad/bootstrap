describe('buttons', function () {
  ...
  describe('checkbox', function () {
    ...
    it('should work correctly with default model values', function () {
      ...
      expect(btn).not.toHaveClass('tb-active');

      $scope.model = true;
      $scope.$digest();
      expect(btn).toHaveClass('tb-active');
    });
  ...
  describe('radio', function () {
    ...
    it('should work correctly set active class based on model', function () {
      ...
      expect(btns.eq(0)).not.toHaveClass('tb-active');
      expect(btns.eq(1)).not.toHaveClass('tb-active');

      $scope.model = 2;
      $scope.$digest();
      expect(btns.eq(0)).not.toHaveClass('tb-active');
      expect(btns.eq(1)).toHaveClass('tb-active');
    });
    ...
    it('should work correctly set active class based on model', function () {
      ...
      btns.eq(0).click();
      expect($scope.model).toEqual(1);
      expect(btns.eq(0)).toHaveClass('tb-active');
      expect(btns.eq(1)).not.toHaveClass('tb-active');
